...
/** 3) 의도적으로 break 조절하기 */
// case는 다르지만 수행해야할 로직이 동일한 경우 의도적으로 break의 위치를 조절 할 수 있다.
...
switch (수학){
    ...
    case 'C':
        ...
        break;
    default:
        console.log("이 과목을 pass하지 못헀습니다.");
        break;
}
...
console.group("4) break의 조건을 식으로 설정 하는 경우");
